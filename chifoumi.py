...
# Label
texte1 = Label(fenetre, text="Humain :", font=("Jokerman", 16), bg="grey")
texte1.grid(row=0,column=0)

texte2 = Label(fenetre, text="Machine :", font=("Jokerman", 16), bg="grey")
texte2.grid(row=0,column=2)

texte3 = Label(fenetre, text="Pour jouer, cliquez sur une des icones ci-dessous:", font=("Kristen ITC", 10), bg="greenyellow")
texte3.grid(row=3, columnspan =3, pady =5)

score1 = Label(fenetre, text="0", font=("Kristen ITC", 16), bg="grey")
score1.grid(row=1, column=0)    

score2 = Label(fenetre, text="0", font=("Kristen ITC", 16), bg="grey")        
...
bouton4 = Button(fenetre,text='Recommencer',command=reinit, bg="cyan")
bouton4.grid(row =5, column =0, pady =10, sticky=E)

bouton5 = Button(fenetre,text='Quitter',command=fenetre.destroy, bg="purple")
